  ...
  return (
    <div className='p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-4'>
      ...
      <div className='flex flex-col gap-4 text-gray-500'>
         ...
         */}
         <UserInfoCardInteraction userId={user.id} currentUserId={currentUserId} isFollowing={isFollowing} isFollowingSent={isFollowingSent} isUserBlocked={isUserBlocked} />
      </div>
    </div>
  )
}
